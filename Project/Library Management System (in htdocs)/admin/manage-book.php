<?php
	...
	$author ="";
	$cat = "";
	$query = "SELECT book_name,book_no,author_name,category_name FROM books";
				...
				<table class="table" width="900px" style="text-align: center">
					...
					<?php 
						...
						while($row = mysqli_fetch_assoc($query_run))
						{
							...
							<td><?php echo $cat; ?></td>
							<td><button class='btn btn-secondary' name=""><a href="delete_book.php?bn=<?php echo $row['book_no']; ?>" class="link-light">Delete</a></button>
						</tr>
							<?php
						}
					?>
