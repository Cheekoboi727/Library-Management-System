<?php
	...
	$student = "";
	$date = "";
	$query = "SELECT issued_books.book_id, issued_books.book_name, issued_books.book_no, issued_books.author_name,Name,issue_date FROM issued_books,users where student_id = Id";
?>	
<!DOCTYPE html>
<html>
<head>
